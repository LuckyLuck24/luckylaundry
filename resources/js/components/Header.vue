      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li v-if="$can('read cashiers')">
              <router-link :to="{ name: 'cashiers.data' }">Cashiers</router-link>
            </li>
            ...
            <li>
              <router-link :to="{ name: 'expenses.data' }">Expenses</router-link>
            </li>
            <li class="dropdown">
              <a
              ...
              <ul class="dropdown-menu" role="menu">
                <li>
                  <router-link :to="{ name: 'transactions.list' }">List</router-link>
                </li>
                <li>
                  <router-link :to="{ name: 'transactions.add' }">Add New</router-link>
                </li>
              </ul>
            </li>
