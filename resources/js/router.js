...
import IndexCashier from './pages/cashiers/Index.vue'
import DataCashiers from './pages/cashiers/Cashier.vue'
import AddCashiers from './pages/cashiers/Add.vue'
import EditCashiers from './pages/cashiers/Edit.vue'
...
const router = new Router({
    ...
    routes: [
        ...
        {
            path: '/cashiers',
            component: IndexCashier,
            meta: { requiresAuth: true },
            children: [
                {
                    path: '',
                    name: 'cashiers.data',
                    component: DataCashiers,
                    meta: { title: 'Manage Cashiers' }
                },
                {
                    path: 'add',
                    name: 'cashiers.add',
                    component: AddCashiers,
                    meta: { title: 'Add New Cashiers' }
                },
                {
                    path: 'edit/:id',
                    name: 'cashiers.edit',
                    component: EditCashiers,
                    meta: { title: 'Edit Cashier' }
                },
            ]
        },
        {
